...
int64_t gamesWon = machine->getMeter(SASConstants::MASTER_GAMES_WON);
int64_t gamesLost = machine->getMeter(SASConstants::MASTER_GAMES_LOST);
...
```cpp
// Specific meter
int64_t coinIn = machine->getMeter(SASConstants::MASTER_COIN_IN);
