...
Machine::Machine(std::shared_ptr<event::EventService> eventService,
    ...
    // Start progressive watchdog thread
...
void Machine::initializeMeters() {
    using namespace sas;
    machineMeters_[SASConstants::MTR_COIN_IN] = 0;
    machineMeters_[SASConstants::MTR_COIN_OUT] = 0;
    machineMeters_[SASConstants::MTR_JACKPOT] = 0;
    machineMeters_[SASConstants::MTR_HANDPAID_CANCELLED_CRD] = 0;
    machineMeters_[SASConstants::MTR_CANCELLED_CRD] = 0;
    machineMeters_[SASConstants::MTR_GAMES_PLAYED] = 0;
    machineMeters_[SASConstants::MTR_GAMES_WON] = 0;
    machineMeters_[SASConstants::MTR_GAMES_LOST] = 0;
    machineMeters_[SASConstants::MTR_CRD_FR_COIN_ACCEPTOR] = 0;
    machineMeters_[SASConstants::MTR_CRD_PAID_FR_HOPPER] = 0;
    machineMeters_[SASConstants::MTR_CRD_FR_COIN_TO_DROP] = 0;
    machineMeters_[SASConstants::MTR_CRD_FR_BILL_ACCEPTOR] = 0;
    machineMeters_[SASConstants::MTR_CURRENT_CRD] = 0;
    machineMeters_[SASConstants::MTR_TOT_TKT_IN] = 0;
    machineMeters_[SASConstants::MTR_TOT_TKT_OUT] = 0;
    machineMeters_[SASConstants::MTR_TOT_DROP] = 0;
    machineMeters_[SASConstants::MTR_REG_CASH_TKT_IN] = 0;
    machineMeters_[SASConstants::MTR_REST_PROMO_TKT_IN] = 0;
    machineMeters_[SASConstants::MTR_1_BILLS_ACCEPTED] = 0;
    machineMeters_[SASConstants::MTR_5_BILLS_ACCEPTED] = 0;
    machineMeters_[SASConstants::MTR_10_BILLS_ACCEPTED] = 0;
    machineMeters_[SASConstants::MTR_20_BILLS_ACCEPTED] = 0;
    machineMeters_[SASConstants::MTR_50_BILLS_ACCEPTED] = 0;
    machineMeters_[SASConstants::MTR_100_BILLS_ACCEPTED] = 0;
}
...
int64_t Machine::getGamesPlayed() const {
    return getMeter(sas::SASConstants::MTR_GAMES_PLAYED);
}
...
int64_t Machine::getCredits() const {
    return getMeter(sas::SASConstants::MTR_CURRENT_CRD);
}
...
void Machine::addCredits(int64_t credits) {
    incrementMeter(sas::SASConstants::MTR_CURRENT_CRD, credits);
}
...
int64_t Machine::getRestrictedCredits() const {
    return getMeter(sas::SASConstants::MTR_CURRENT_REST_CRD);
}
...
void Machine::addRestrictedCredits(int64_t credits) {
    incrementMeter(sas::SASConstants::MTR_CURRENT_REST_CRD, credits);
}
...
int64_t Machine::getNonRestrictedCredits() const {
    return getMeter(sas::SASConstants::MTR_CURRENT_NON_REST_CRD);
}
...
void Machine::addNonRestrictedCredits(int credits) {
    incrementMeter(sas::SASConstants::MTR_CURRENT_NON_REST_CRD, credits);
}
...
void Machine::addJackpot(double award) {
    ...
    incrementMeter(sas::SASConstants::MTR_JACKPOT, awardCredits);
}

void Machine::addCoinOut(double coinOut) {
    int64_t awardCredits = static_cast<int64_t>(coinOut / getAccountingDenom());
    addCredits(awardCredits);
    incrementMeter(sas::SASConstants::MTR_COIN_OUT, awardCredits);
}
...
int64_t Machine::getCreditsByGameDenom() const {
    ...
    return static_cast<int64_t>((getAccountingDenom() * getMeter(sas::SASConstants::MTR_CURRENT_CRD)) /
...
int64_t Machine::getRestrictedCreditsByGameDenom() const {
    ...
    return static_cast<int64_t>((getAccountingDenom() * getMeter(sas::SASConstants::MTR_CURRENT_REST_CRD)) /
                                currentGame_->getDenom());
}
...
int64_t Machine::getNonRestrictedCreditsByGameDenom() const {
    ...
    return static_cast<int64_t>((getAccountingDenom() * getMeter(sas::SASConstants::MTR_CURRENT_NON_REST_CRD)) /
                                currentGame_->getDenom());
}
...
void Machine::gameStart(int credits) {
    checkPlayable();
    playable_ = false;
    incrementMeter(sas::SASConstants::MTR_GAMES_PLAYED, 1);

    if (currentGame_) {
        double amount = currentGame_->bet(credits);
        incrementMeter(sas::SASConstants::MTR_COIN_IN, static_cast<int>(toAccountingDenom(amount)));
        eventService_->publish(GamePlayedEvent(currentGame_, amount));

        for (auto& port : ports_) {
            port->gameStarted(credits, currentGame_->getDenom());
        }
    }
}
...
void Machine::GameWon() {
    incrementMeter(sas::SASConstants::MTR_GAMES_WON, 1);
}

void Machine::GameLost() {
    incrementMeter(sas::SASConstants::MTR_GAMES_LOST, 1);
}
...
void Machine::addPendingHandpay(double amount, int levelId) {
    ...
    for (auto& port : ports_) {
        port->handpayPending(levelId, amount);
    }
}
...
void Machine::doRamClear() {
    int64_t credits = getMeter(sas::SASConstants::MTR_CURRENT_CRD);
    initializeMeters();
    addCredits(static_cast<int>(credits));
...
int64_t Machine::getCoinOutMeter() const {
    return getMeter(sas::SASConstants::MTR_COIN_OUT);
}
...
int64_t Machine::getDropMeter() const {
    return getMeter(sas::SASConstants::MTR_CRD_FR_COIN_TO_DROP);
}
...
int64_t Machine::getJackpotMeter() const {
    return getMeter(sas::SASConstants::MTR_JACKPOT);
}
...
// Port management
std::shared_ptr<MachineCommPort> Machine::addSASPort() {
    if (!platform_) {
        return nullptr;
    }
...
std::shared_ptr<MachineCommPort> Machine::getPrimarySASPort() {
